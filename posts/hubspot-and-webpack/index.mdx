...
<p>
  ...
  you generally know what's goin on, then run this command in Terminal—inside of
  your project folder.
</p>
...
```js
npm install --save-dev webpack webpack-cli copy-webpack-plugin @hubspot/webpack-cms-plugins clean-webpack-plugin
```
...
<h2>Create a MINIMAL webpack.config.js</h2>
<p>
  Modify the&nbsp;
  <a href='https://www.npmjs.com/package/@hubspot/webpack-cms-plugins'>
    example&nbsp;
  </a>
  webpack.config.js to support Webpack 5 + the required plugin updates
</p>
...
<p>Add these scripts to your package.json file</p>
