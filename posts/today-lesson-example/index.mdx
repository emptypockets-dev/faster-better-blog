---
title: Ad hoc code snippets
image: ./thumb-7.png
imageAlt: Coding lesson
description: Saving lessons and code snippets so that I don't forget them. You might want to use these too.
tags: ['react', 'gatsby', 'javascript', 'random']
---
